...
public class JWTUtil {
    ...
    // Base64-encoded HMAC-SHA256 secret. Overridable via JWT_SECRET env var.
    // Default is the original key so existing tokens remain valid.
    @Value("${jwt.secret:bXktc3VwZXItc2VjcmV0LWtleS0xMjM0NTY3ODkwMTI=}")
    ...
    private Key getSigningKey() {
        // Configurable via jwt.secret / JWT_SECRET (Base64-encoded).
